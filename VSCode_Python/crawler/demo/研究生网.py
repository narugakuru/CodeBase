...
time.sleep(random.random())
web.find_element_by_xpath('//*[@id="mldm"]/optgroup[2]/option[8]').click()  # 类别
time.sleep(random.random())
...
time.sleep(1)
# 查询跳转
web.find_element_by_xpath('//*[@id="form2"]/table/tbody/tr[4]/td/input').click()
time.sleep(1)

# 获取所有大学的a链接列表 类型WebElement
aList = web.find_element_by_class_name("ch-table").find_elements_by_name("form3")

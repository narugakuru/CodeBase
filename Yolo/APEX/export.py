...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=r"C:\Users\admin\Desktop\APEX\coco128.yaml", help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default="416nG6.pt", help='model.pt path(s)')

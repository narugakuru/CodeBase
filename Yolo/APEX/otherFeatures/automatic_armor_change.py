...
from otherFeatures.delay import delay_ms
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.local_image = cv2.cvtColor(cv2.imread('otherFeatures/image/local_image.png'), cv2.COLOR_BGR2GRAY)
        # 截图xy坐标长宽
        self.x = float(120)
        self.y = float(115)

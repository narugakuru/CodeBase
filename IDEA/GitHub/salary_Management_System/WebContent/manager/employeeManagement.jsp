		...
		<div class="main-wrap">
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					...
					<a href="employeeManagement.jsp"><span class="crumb-name">员工管理</span></a>
				</div>
			</div>
				...
				<form name="myform" id="myform" method="post">
					<div class="result-title">
						<div class="result-list">
							<a href="Register.jsp"><i class="icon-font">&#xe002;</i>添加员工信息</a>
							<a id="updateOrd" href="employeeManagement.jsp"><i class="icon-font">&#xe017;</i>更新员工信息</a>
						</div>
					</div>
					<%
						try {
					...
					<div class="result-content">
						<table class="result-tab" width="100%">
							...
							<%
								...
								String sql = "SELECT name FROM userlogin;"; //查询语句
							...
							<tr>
								...
								<td align="center">
								<a class="link-del" href="../DeleteStudent?name=<%=rs.getString("name")%>">删除</a>
								</td>
							</tr>
							<%
								}

	...
	<div class="container clearfix">
		...
		<div class="main-wrap">
			...
			<div class="result-wrap">
				...
				<div class="result-content">
					<div class="short-wrap">
						...
						<a href="employeeManagement.jsp"><i class="icon-font">&#xe00f;</i>员工管理</a>
						<a href="salarycheck.jsp"><i class="icon-font">&#xe005;</i>工资查看</a>
						<a href="message.jsp"><i class="icon-font">&#xe004;</i>留言管理</a>
						<a href="allrecord.jsp"><i class="icon-font">&#xe004;</i>员工考勤信息</a>
					</div> 
				</div>
			</div>
			<div class="result-wrap">
			...
			<div class="result-wrap">
				...
				<div class="result-content">
					<ul class="sys-info-list">
						<li><label class="res-lab">更多帮助请评论区留言</label><span
							class="res-info"> <a href="message.jsp">留言区</a></span></li>
					</ul>
				</div>
			</div>
		</div>
